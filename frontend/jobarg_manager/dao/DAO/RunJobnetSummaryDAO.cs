...
namespace jp.co.ftf.jobcontroller.DAO
{
    ...
    public class RunJobnetSummaryDAO : BaseDAO
    {
        ...
        // added by YAMA 2014/12/03    (V2.1.0 No11)
        ...
        //private String _select_run_jobnet = "select JRAll.* from ((select JR.* from "
        //                                        + "ja_run_jobnet_summary_table AS JR "
        //                                        + "where (((JR.scheduled_time between ? and ?) OR (JR.start_time between ? and ?) OR ((JR.scheduled_time = 0) and (JR.start_time between ? and ?)) OR ((JR.scheduled_time = 0) and (JR.start_time = 0) and (multiple_start_up = 2))) and JR.public_flag=1 ) or start_pending_flag = 1 ) "
        //                                        + "union "
        //                                        + "(select JR.* from "
        //                                        + "ja_run_jobnet_summary_table AS JR, users AS U, users_groups AS UG1, users_groups AS UG2 "
        //                                        + "where (((JR.scheduled_time between ? and ?) OR (JR.start_time between ? and ?) OR ((JR.scheduled_time = 0) and (JR.start_time between ? and ?)) OR ((JR.scheduled_time = 0) and (JR.start_time = 0) and (multiple_start_up = 2)))  and "
        //                                        + "JR.public_flag=0 and JR.user_name=U.alias and U.userid=UG1.userid and UG2.userid=? and UG1.usrgrpid=UG2.usrgrpid) or start_pending_flag = 1 )) "
        //                                        + "as JRAll "
        //                                        + "order by JRAll.scheduled_time,JRAll.start_time,JRAll.inner_jobnet_id";
        private String _select_run_jobnet = "select JRAll.* from ((select JR.* from "
                                                + "ja_run_jobnet_summary_table AS JR "
                                                ...
                                                + "where (((JR.scheduled_time between ? and ?) OR (JR.start_time between ? and ?) OR ((JR.scheduled_time = 0) and (JR.start_time between ? and ?)) OR ((JR.scheduled_time = 0) and (JR.start_time = 0) and (multiple_start_up = 2)))  and "
                                                + "JR.public_flag=0 and JR.user_name=U.alias and U.userid=UG1.userid and UG2.userid=? and UG1.usrgrpid=UG2.usrgrpid)) "
                                                + "union (select JR.* from ja_run_jobnet_summary_table AS JR where start_pending_flag = 1)) "
                                                + "as JRAll "
                                                + "order by JRAll.scheduled_time,JRAll.start_time,JRAll.inner_jobnet_id";
        ...
        //特権ユーザー以外のグループ所属無しユーザーの実行ジョブリスト取得SQL文
        ...
        //                                        + "ja_run_jobnet_summary_table AS JR, users AS U "
        //                                        + "where (((JR.scheduled_time between ? and ?) OR (JR.start_time between ? and ?) OR ((JR.scheduled_time = 0) and (JR.start_time between ? and ?)) OR ((JR.scheduled_time = 0) and (JR.start_time = 0) and (multiple_start_up = 2)))  and "
        //                                        + "JR.public_flag=0 and JR.user_name=U.alias) or start_pending_flag = 1 )) "
        //                                        + "as JRAll "
        //                                        + "order by JRAll.scheduled_time,JRAll.start_time,JRAll.inner_jobnet_id";
        private String _select_run_jobnet_not_belongGRP = "select JRAll.* from ((select JR.* from "
                                                + "ja_run_jobnet_summary_table AS JR "
